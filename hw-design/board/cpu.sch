...
U 1 1 54E5DFA7
P 8850 4900
F 0 "#PWR033" H 8850 4650 60  0001 C CNN
...
U 1 1 54F2A3AF
P 9300 4600
F 0 "P2" H 9300 4900 50  0000 C CNN
...
F 4 "-" H -350 950 50  0001 C CNN "MPN"
	1    9300 4600
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 556F3A3A
P 5550 3750
F 0 "U4" H 4050 5150 50  0000 C CNN
...
U 1 1 556F5E37
P 3200 5050
F 0 "C10" H 3225 5150 50  0000 L CNN
F 1 "18pF" H 3225 4950 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 3238 4900 30  0000 C CNN
...
U 1 1 556F5E74
P 2950 5050
F 0 "C9" H 2975 5150 50  0000 L CNN
F 1 "18pF" H 2975 4950 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 2988 4900 30  0000 C CNN
...
U 1 1 556F65EC
P 3200 5250
F 0 "#PWR035" H 3200 5000 50  0001 C CNN
...
U 1 1 55705A80
P 5550 1500
F 0 "#PWR036" H 5550 1350 50  0001 C CNN
...
U 1 1 557DBC57
P 5250 1850
F 0 "C11" V 5300 1650 40  0000 L CNN
F 1 "100nF X7R" V 5100 1700 40  0000 L CNN
...
U 1 1 557DBEEF
P 5850 1850
F 0 "C12" V 5900 1650 40  0000 L CNN
F 1 "100nF X7R" V 6000 1700 40  0000 L CNN
...
U 1 1 557DC875
P 5250 2100
F 0 "#PWR037" H 5250 1850 50  0001 C CNN
...
U 1 1 557DCAD9
P 5850 2100
F 0 "#PWR038" H 5850 1850 50  0001 C CNN
...
U 1 1 557F309A
P 1800 2800
F 0 "P1" H 1800 3050 50  0000 C CNN
F 1 "CHAIN" V 1900 2800 50  0000 C CNN
F 2 "Pin_Headers:Pin_Header_Straight_1x04" H 1800 2800 60  0001 C CNN
F 3 "" H 1800 2800 60  0000 C CNN
F 4 "-" H 350 1550 50  0001 C CNN "MPN"
	1    1800 2800
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 557F3440
P 2050 3000
F 0 "#PWR040" H 2050 2750 50  0001 C CNN
...
U 1 1 558018EB
P 9650 2150
F 0 "R6" V 9750 2150 50  0000 C CNN
F 1 "10k" V 9650 2150 50  0000 C CNN
F 2 "Resistors_SMD:R_0603" V 9580 2150 30  0000 C CNN
F 3 "" H 9650 2150 30  0000 C CNN
F 4 "RMCF0603JT10K0" H -350 650 50  0001 C CNN "MPN"
	1    9650 2150
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 55802FA1
P 9650 1900
F 0 "#PWR041" H 9650 1750 50  0001 C CNN
...
U 1 1 55803C49
P 9650 2900
F 0 "#PWR042" H 9650 2650 50  0001 C CNN
F 1 "GNDD" H 9650 2750 50  0000 C CNN
...
U 1 1 55804D28
P 9650 2650
F 0 "C13" V 9700 2500 40  0000 L CNN
F 1 "100nF X7R" V 9500 2500 40  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 9688 2500 30  0001 C CNN
...
U 1 1 558060C0
P 9250 2800
F 0 "SW1" H 9400 2910 50  0000 C CNN
F 1 "SW_PUSH" H 9250 2720 50  0000 C CNN
F 2 "Buttons_Switches_SMD:SW_SPST_FSMSM" H 9250 2800 60  0000 C CNN
F 3 "" H 9250 2800 60  0000 C CNN
F 4 "FSMSM" H -350 650 50  0001 C CNN "MPN"
	1    9250 2800
	0    -1   1    0   
$EndComp
$Comp
...
U 1 1 55806665
P 9250 3200
F 0 "#PWR043" H 9250 2950 50  0001 C CNN
F 1 "GNDD" H 9250 3050 50  0000 C CNN
...
SWDIO
Text GLabel 9000 2400 0    50   Output ~ 0
RESET
